...
I created a Dockerfile using Ubuntu as the base image. Inside it, I installed basic Linux utilities and copied a shell script that runs basic Linux commands.
...
git remote add origin https://github.com/Siddiqui2807/My_dockerApp
